const quizQuestions = {
	...
	list:     [
		...
		{
			"query":     "At sea level, what temperature is required to boil water?",
			"answer":    "100° Celsius",
			"responses": [
				"32° Celsius",
				"98.6° Celsius",
		...
		{
			"query":     "In the original (Italian) version of Cindarella, what was the fairy god mother?",
			"answer":    "A cat",
			"responses": [
				"A dog",
				"A goat",
		...
		{
			"query":     "Which country eats the most macaroni and cheese?",
			"answer":    "Canada",
			"responses": [
				"France",
				"Germany",
		...
		{
			"query":     "Which word means the opposite of paranoia, meaning wishing to do everybody good?",
			"answer":    "Pronoia",
			"responses": [
				"Antiparanoia",
				"Apophenia",
		...
		{
			"query":     "The blue whale is the biggest animal in the world. What is the biggest object it can swallow?",
			"answer":    "Beach ball",
			"responses": [
				"Car",
				"Cat",
